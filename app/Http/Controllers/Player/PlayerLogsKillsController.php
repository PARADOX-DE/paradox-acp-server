...
/**
 * Class PlayerLogsKillsController
 * @package App\Http\Controllers\Player
 */
class PlayerLogsKillsController extends Controller
{
    /**
     * __construct
     *
    ...
    public function __construct(
        ...
        private LogKill $logKillRepository,
    ...
    public function list(DatagridFilterRequest $request, int $id): \Illuminate\Http\JsonResponse
    {
        ...
        $queryBuilder = $this->logKillRepository::query()
            ->where('killer', $player->name)
            ->orWhere('user', $player->name);
