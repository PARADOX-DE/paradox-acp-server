...
class VehicleInventoryController extends Controller
{
    ...
    public function delete(InventoryDeleteItemRequest $request, int $id): CallbackMessageResource
    {
        ...
        $this->adminLogService->execute($request->user()->id, $vehicle->id, 'VEHICLE', "Item Slot: {$slot} gelöscht.");
    ...
    public function add(InventoryAddItemRequest $request, int $id): InventoryAddedItemResource
    {
        ...
        $this->adminLogService->execute($request->user()->id, $vehicle->id, 'VEHICLE', "{$request->get('amount')}x {$itemModel->name} hinzugefügt.");
    ...
    public function clear(Request $request, int $id): CallbackMessageResource
    {
        ...
        $this->adminLogService->execute($request->user()->id, $vehicle->id, 'vehicle', "Inventar geleert.");
